...
namespace tcpServer
{
    ...
    public partial class TcpServer : Component
    {
        ...
        //++++++++++++++++++++++++++++++++ capturar ips de clientes remotos ++++++++++++++++++++++++
        public  string RemoteClientIPPOPRT()
        {
            string clienteipremoto;
            string otroipport = "";

            foreach (TcpServerConnection connm in connections)
            {
                clienteipremoto = connm.Capturaripyport();
                return clienteipremoto;
            }
            //clienteipremoto = clienteipportremoto.capturaripyport();
        ...
        public void SendString(string[] datastring)
        {
            lock (sem)
            {
                ...
                {
                    //conn.sendData(data);
                    conn.sendDataString(datastring);
